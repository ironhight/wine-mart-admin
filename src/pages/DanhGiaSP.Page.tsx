...
import ChildDanhGiaSP from "../components/DanhGiaSP/ChildDanhGiaSP";
import ModalDanhGiaSP from "../components/DanhGiaSP/ModalDanhGiaSP";
...
class DanhGiaSP extends Component<Props, State> {
  componentDidMount() {
    this.props.getColums("danhGiaSP");
  }
...
const mapDispatchToProps = (dispatch: any) => {
  return {
    getColums: (string: string) => {
      dispatch(columsAction.columsDanhGiaSP(string));
    }
  };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(DanhGiaSP);
