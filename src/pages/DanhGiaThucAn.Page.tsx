...
import ChildDanhGiaThucAn from "../components/DanhGiaThucAn/ChildDanhGiaThucAn";
import ModalDanhGiaThucAn from "../components/DanhGiaThucAn/ModalDanhGiaThucAn";
...
class DanhGiaThucAn extends Component<Props, State> {
  componentDidMount() {
    this.props.getColums("danhGiaThucAn");
  }
          ...
          <div className="row">
            ...
            <div className="col-2 px-0">
              <button
                ...
                data-toggle="modal"
                data-target="#modelDanhGiaThucAn"
                style={{
...
const mapDispatchToProps = (dispatch: any) => {
  return {
    getColums: (string: string) => {
      dispatch(columsAction.columsDanhGiaThucAn(string));
    }
  };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(DanhGiaThucAn);
