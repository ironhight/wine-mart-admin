...
import ChildNhaMay from "../components/NhaMaySXRuou/ChildNhaMaySXRuou";
import ModalNhaMay from "../components/NhaMaySXRuou/ModalNhaMaySXRuou";
...
class NhaMay extends Component<Props, State> {
  componentDidMount() {
    this.props.getColums("nhaMay");
  }
  ...
  render() {
    ...
    return (
      <div className="page">
        ...
        >
          Danh sách nhà máy sản xuất rượu
        </h2>
...
const mapDispatchToProps = (dispatch: any) => {
  return {
    getColums: (string: string) => {
      dispatch(columsAction.columsNhaMay(string));
    }
  };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(NhaMay);
