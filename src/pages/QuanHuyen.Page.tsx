...
import ChildQuanHuyen from "../components/QuanHuyen/ChildQuanHuyen";
import ModalQuanHuyen from "../components/QuanHuyen/ModalQuanHuyen";
...
class QuanHuyen extends Component<Props, State> {
  componentDidMount() {
    this.props.getColums("quanHuyen");
  }
...
const mapDispatchToProps = (dispatch: any) => {
  return {
    getColums: (string: string) => {
      dispatch(columsAction.columsQuanHuyen(string));
    }
  };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(QuanHuyen);
