...
import ChildThucAnKem from "../components/ThucAnKem/ChildThucAnKem";
import ModalThucAnKem from "../components/ThucAnKem/ModalThucAnKem";
...
class ThucAnKem extends Component<Props, State> {
  componentDidMount() {
    this.props.getColums("thucAnKem");
  }
...
const mapDispatchToProps = (dispatch: any) => {
  return {
    getColums: (string: string) => {
      dispatch(columsAction.columsThucAnKem(string));
    }
  };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(ThucAnKem);
