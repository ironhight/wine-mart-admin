...
import ChildVung from "../components/Vung/ChildVung";
import ModalVung from "../components/Vung/ModalVung";
...
class Vung extends Component<Props, State> {
  componentDidMount() {
    this.props.getColums("vung");
  }
...
const mapDispatchToProps = (dispatch: any) => {
  return {
    getColums: (string: string) => {
      dispatch(columsAction.columsVung(string));
    }
  };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(Vung);
